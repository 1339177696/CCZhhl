package com.hulian.oa.agency.fragment;
...
import com.hulian.oa.agency.adapter.HascomAdapter_qgl;
...
//待办-》已办
public class HascomFragment extends Fragment implements PullLoadMoreRecyclerView.PullLoadMoreListener {
...
//    }
    ...
    public void onEventMainThread(HascomFragment event) {
        onRefresh();
    }
