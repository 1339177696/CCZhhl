...
import com.hulian.oa.agency.adapter.UpcomAdapter_qgl;
...
//待办-》待办
public class UpcomFragment extends Fragment implements PullLoadMoreRecyclerView.PullLoadMoreListener {
    ...
    public void onEventMainThread(UpcomFragment event) {
        onRefresh();
    }
