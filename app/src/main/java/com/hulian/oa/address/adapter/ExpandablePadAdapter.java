...
public class ExpandablePadAdapter extends BaseExpandableListAdapter {
    //视图加载器
     ...
     */
    public ExpandablePadAdapter(Context context, List<Department> groupData, int expandedGroupLayout,
