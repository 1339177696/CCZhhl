...
public class LuncherActivity_ceshi extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        login=new Intent(LuncherActivity_ceshi.this, LoginActivity_ceshi.class);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                if(SPUtils.contains(mContext,"userId")) {
                    ...
                    Intent intent = new Intent(LuncherActivity_ceshi.this, LoginActivity_ceshi.class);
                    startActivity(intent);
                    LuncherActivity_ceshi.this.finish();
                }
            }
        }, 2000);
        //绑定服务
    ...
    public void PostKeyValueRequet(String account1,String token1) {
        ...
        HttpRequest.postLoginApi(params, new ResponseCallback() {
            ...
            public void onSuccess(Object responseObj) {
                ...
                Intent intent=new Intent(LuncherActivity_ceshi.this, MainActivity.class);
                startActivity(intent);
                //启动服务
            ...
            public void onFailure(OkHttpException failuer) {
                Toast.makeText(LuncherActivity_ceshi.this, "请求失败="+failuer.getEmsg(), Toast.LENGTH_SHORT).show();
                // 跳转登录页
                startActivity(login);
            }
        });
