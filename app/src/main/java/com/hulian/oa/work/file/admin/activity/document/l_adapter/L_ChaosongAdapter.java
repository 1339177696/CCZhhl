...
public class L_ChaosongAdapter extends RecyclerView.Adapter <L_ChaosongAdapter.ViewHolder> {
    ...
    public L_ChaosongAdapter(Context context, String type) {
        mContext = context;
        this.type=type;
    }
    ...
    @Override
    public L_ChaosongAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.l_item_approved, parent, false);
        return new L_ChaosongAdapter.ViewHolder(v);
    }
