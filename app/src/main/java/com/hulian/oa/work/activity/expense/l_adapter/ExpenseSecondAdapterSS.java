...
public class ExpenseSecondAdapterSS extends
        RecyclerView.Adapter<ExpenseSecondAdapterSS.ViewHolder> {
    ...
    public ExpenseSecondAdapterSS(Context context, onAddPicClickListener mOnAddPicClickListener, int mPosition) {
                ...
                if (mItemClickListener != null) {
                    viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Log.e("ExpenseSecondAdapterSS","点击时间");
                        }
                    });
                }
                // 图片点击事件
