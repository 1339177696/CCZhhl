...
import com.hulian.oa.work.file.admin.activity.notice.adapter.GridViewAdapter;
...
public class NoticeIssueActivity extends BaseActivity {
    ...
    private L_GridImageAdapter adapterimage;
    //已经选择图片
...
//                        iv_document.setImageBitmap(bitmap);
    ...
    private void init() {
        ...
        adapterimage = new L_GridImageAdapter(mContext, onAddPicClickListener);
        adapterimage.setList(selectList);
        adapterimage.setSelectMax(maxSelectNum);
        recyclerView.setAdapter(adapterimage);

        adapterimage.setOnItemClickListener(new L_GridImageAdapter.OnItemClickListener() {
            @Override
