...
import com.hulian.oa.work.file.admin.activity.meeting.SelPeopleActivity_meet_people;
import com.hulian.oa.work.file.admin.activity.task.SelPeopleActivity_task_people;
...
public class MyTaskAdapter extends BaseAdapter {
    ...
    private SelPeopleActivity_task_people.AllCheckListener allCheckListener;

    public MyTaskAdapter(List<People> data, Context context, SelPeopleActivity_task_people.AllCheckListener allCheckListener) {
        this.data = data;
