package com.hulian.oa.work.file.admin.activity.mypreview;
...
/**
 */
public class PicturePreviewActivity2 extends PictureBaseActivity implements View.OnClickListener {
    ...
    private PicturePreviewActivity2.SimpleFragmentAdapter adapter;
    ...
    private void initViewPageAdapterData() {
        ...
        tv_title.setText("");
        adapter = new PicturePreviewActivity2.SimpleFragmentAdapter();
...
//                    Glide.with(PicturePreviewActivity2.this)
//                            .asBitmap()
//                            .load(path)
//                            .apply(options)
...
//            }
            LocalMedia media = images.get(position);
            longImg.setImage(ImageSource.resource(Integer.parseInt(media.getPath())));
