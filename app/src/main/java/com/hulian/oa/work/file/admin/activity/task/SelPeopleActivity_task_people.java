...
import com.hulian.oa.work.file.admin.activity.task.l_adapter.MyTaskAdapter;
...
//人员
public class SelPeopleActivity_task_people extends BaseActivity {
    //创建显示列表的listView
    ...
    private MyTaskAdapter mMyAdapter;
    //监听来源
...
//                    listView.setAdapter(adapter);
    ...
    private void initViewOper(List<People> models ) {
        mMyAdapter = new MyTaskAdapter(models, this, new SelPeopleActivity_task_people.AllCheckListener() {
