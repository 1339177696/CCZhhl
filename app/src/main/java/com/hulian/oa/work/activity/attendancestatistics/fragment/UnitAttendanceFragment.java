...
public class UnitAttendanceFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        titleDatas.add("请假");
        titleDatas.add("早退");
        fragmentList.add(UnitListFragment.newInstance("0"));
        fragmentList.add(UnitListFragment.newInstance("1"));
        fragmentList.add(UnitListFragment.newInstance("2"));
        fragmentList.add(UnitListFragment.newInstance("3"));
        fragmentList.add(UnitListFragment.newInstance("4"));
        fragmentList.add(UnitListFragment.newInstance("5"));
