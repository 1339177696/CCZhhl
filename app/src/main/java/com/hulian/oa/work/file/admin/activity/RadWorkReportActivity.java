 ...
 * Describe:工作汇报
 */
public class RadWorkReportActivity extends BaseActivity {
...
//        }else {
            //替换tab中原有的样式(职工)
//            myTablayout.getTabAt(0).setCustomView(R.layout.item_bx_tab_f);
            myTablayout.getTabAt(0).setCustomView(R.layout.item_bx_tab_s);
//            TextView textView = myTablayout.getTabAt(0).getCustomView().findViewById(R.id.tv_title);
//            ImageView imageView = myTablayout.getTabAt(0).getCustomView().findViewById(R.id.iv_pic);
            TextView textView1 = myTablayout.getTabAt(0).getCustomView().findViewById(R.id.tv_title);
            ImageView imageView1 = myTablayout.getTabAt(0).getCustomView().findViewById(R.id.iv_pic);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()){
            case R.id.tv_apply://筛选
                startActivity(new Intent(RadWorkReportActivity.this,ScreenReportActivity.class));
                break;
            case R.id.iv_back:
                finish();
                break;
