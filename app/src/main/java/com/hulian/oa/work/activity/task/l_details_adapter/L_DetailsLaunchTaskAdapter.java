package com.hulian.oa.work.activity.task.l_details_adapter;
...
public class L_DetailsLaunchTaskAdapter extends RecyclerView.Adapter <RecyclerView.ViewHolder>{
    ...
    public L_DetailsLaunchTaskAdapter(Context context) {
        mContext = context;
    }
...
//                qgl
                ...
                if (aa!=null&&aa!=""){
                    ...
                    for (int i = 0;i<=c.size()-1;i++){
                        ...
                        if (getMIMEType(c.get(i)).equals("image/jpeg")||getMIMEType(c.get(i)).equals("image/png")||getMIMEType(c.get(i)).equals("image/gif")){
                            ...
                            path_x = c.get(i);
                            viewHolderTop.tv_qgl_file.setText(path_x);
                        }

                    }
                }
                viewHolderTop.tv_qgl_file.setOnClickListener(new View.OnClickListener() {
                    @Override
                ...
                if (dataList.get(position).getContent()!=null)
                {
                    ...
                    viewHolderList.tv_file.setVisibility(View.GONE);
                    viewHolderList.tv_content.setText(dataList.get(position).getContent());
                }
                else
                {
                    if (getMIMEType(dataList.get(position).getPicture()).equals("image/jpeg")||getMIMEType(dataList.get(position).getPicture()).equals("image/png")||getMIMEType(dataList.get(position).getPicture()).equals("image/gif")){
                        viewHolderList.tv_content.setVisibility(View.GONE);
                        viewHolderList.iv_show.setVisibility(View.VISIBLE);
                        viewHolderList.tv_file.setVisibility(View.GONE);
                        Glide.with(mContext).load(dataList.get(position).getPicture()).into(((L_DetailsLaunchTaskAdapter.ViewHolder_List) holder).iv_show);
                        ...
                        viewHolderList.tv_content.setVisibility(View.GONE);
                        viewHolderList.iv_show.setVisibility(View.GONE);
                        viewHolderList.tv_file.setVisibility(View.VISIBLE);
                        viewHolderList.tv_file.setText(dataList.get(position).getPicture());
                        path_x1 = dataList.get(position).getPicture();
                    }


                }
                viewHolderList.tv_file.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        downloadFilea(path_x1);
                    }
                });
