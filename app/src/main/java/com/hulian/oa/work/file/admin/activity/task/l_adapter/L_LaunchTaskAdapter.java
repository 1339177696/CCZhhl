...
public class L_LaunchTaskAdapter extends RecyclerView.Adapter <L_LaunchTaskAdapter.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            tv_launchi = (TextView) itemView.findViewById(R.id.tv_launchi);
        }
    }
...
//        holder.tv_deadline_time.setText(dataList.get(position).getEndTime());
        ...
        holder.tv_launch_task_person.setText("发起人："+dataList.get(position).getCreateBy());
        if (dataList.get(position).getCompletion().equals("1"))
        {
            holder.tv_launchi.setVisibility(View.VISIBLE);
        }
        else
        {
            holder.tv_launchi.setVisibility(View.GONE);
        }
