package com.hulian.oa.work.activity.meeting.l_fragment;
...
import com.hulian.oa.work.activity.meeting.l_adapter.MeetLaunchAdapter;
...
public class MeetReceiverFragment extends Fragment implements PullLoadMoreRecyclerView.PullLoadMoreListener {
    ...
    // 刷新
    public void onEventMainThread(MeetReceiverFragment event) {
        onRefresh();
    }
