...
import com.hulian.oa.work.file.admin.activity.notice.NoticeSelPartActivity;
...
public class MyPeopleAdapter extends BaseAdapter {
    ...
    private SelPeopleActivity_meet_people.AllCheckListener allCheckListener;

    public MyPeopleAdapter(List<People> data, Context context, SelPeopleActivity_meet_people.AllCheckListener allCheckListener) {
        this.data = data;
