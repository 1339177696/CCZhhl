package com.hulian.oa.message.session;
...
public class UserProfileActivity extends UI {
    ...
    private Button chatBtn,begin_message;
    private TextView begin_phone;
...
//        headImageView = findView(R.id.user_head_image);
        ...
        begin_message=findView(R.id.begin_message);
        chatBtn = findView(R.id.begin_chat);
        begin_phone=findView(R.id.begin_phone);
...
//        });
        begin_message.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sendIntent.setData(Uri.parse("smsto:" + userInfo.getAccount()));
...
//        headImageView.setImageResource(R.drawable.nim_avatar_default);
    ...
    private void updateUserOperatorView() {
        ...
        begin_phone.setVisibility(View.VISIBLE);
    ...
    private View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            else  if(v==begin_phone){
                Intent intent = new Intent(Intent.ACTION_DIAL);
                Uri data = Uri.parse("tel:" + userInfo.getAccount());
                intent.setData(data);
